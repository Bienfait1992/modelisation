/*
  ...
  - You are about to alter the column `Telephone` on the `Apprenant` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
